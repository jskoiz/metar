...
/**
 * Configuration for MetarClient.
 */
export interface MetarClientConfig {
...
/**
 * MetarClient provides a high-level interface for making paid API requests.
 *
...
export class MetarClient {
  ...
  private config: MetarClientConfig;

  constructor(config: MetarClientConfig) {
    // Validate config
    if (
      ...
      throw new Error("Invalid MetarClient configuration");
    }
